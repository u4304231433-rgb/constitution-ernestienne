...
Les anciens citoyens sont ceux ayant au minimum 5 jours d’ancienneté, et s'étant exprimés à au moins 3 des 10 derniers votes.
\article{}
Est défini comme territoire national le serveur Discord de l’Ernestie, le bassin aux Ernests de la Courô du 45 rue d’Ulm, Paris (75005) ansi que les flaques présentes dans cette même cour. Cette surface est choisie comme capitale territoriale de l’Ernestie.
\article{}
...
\Article{Conseillers permanents et honoraires}
\article{}
La présente constitution reconnaît le statut de conseiller permanent au propriétaire du serveur Discord “Ernestie”.
\article{}
\subarticle{}
L’ensemble des conseillers permanents forme le conseil des conseillers permanents ou conseil permanent.
\subarticle{}
...
\article{}
Le statut de conseiller permanent peut être acquis par tout ancien citoyen étudiant actuellement à l’Ecole Normale Supérieure de Paris en récompense de son mérite au regard de la DENS. Un ou plusieurs anciens citoyens peuvent être nommés conseillers permanents, sur demande au conseil permanent et suite au vote favorable d’au moins $\frac{2}{3}$ de ses membres.
\article{}
Un conseiller permanent peut être promu conseiller honoraire par un vote à majorité du conseil constitutionnel après avoir siégé au moins un an au conseil des conseillers permanents. Il peut alors conserver son statut de conseiller permanent tant qu’il reste étudiant de l’ENS Ulm. Après cela, ce statut devient purement honorifique ; il prend le nom de conseiller honoraire émérite. Un membre permanent quittant l’ENS devient donc honoraire émérite. Il ne peut y avoir plus de 13 membres honoraires.
\article{}
Un nombre maximal de 5 conseillers permanents (hors honoraires) au conseil permanent est institué.
\article{}
...
\article{}
Dans le cas où il n’y a plus de conseiller permanent (hors honoraires émérites), les membres élus du conseil constitutionnel ont deux jours pour désigner un conseiller permanent parmi eux. S’ils ne parviennent à se mettre d’accord, un conseiller permanent est tiré au sort parmi le conseil élu. S’il n’existe aucun conseiller constitutionnel, un conseiller permanent est tiré au sort parmi les anciens citoyens.
...
\article{}
\subarticle{}
L’état d’urgence donne au conseil des conseillers permanents la possibilité de promulguer toutes les lois qu’il souhaite, dans le respect de la constitution, ainsi que de déchoir tout citoyen non permanent de sa citoyenneté. Il ne peut modifier la présente constitution.
\subarticle{}
Pendant l’état d’urgence, toute prise de décision du conseil des conseillers permanents s’effectue par vote à majorité aux $\frac{2}{3}$ .
\subarticle{}
La déchéance de citoyenneté d’un conseiller permanent est également possible mais doit s’accompagner du vote positif des $\frac{3}{4}$ du conseil permanent.
\article{}
...
\titre{Conseil constitutionnel}
\Article{Constitutionnalité}
\articleref{}{Constitutionnalité}
Toute décision officielle, loi, procédure réglementaire ou officielle ou proposition de loi, doit se conformer à la présente constitution.
...
La révision ne peut fixer un nombre de membres élus excédant le nombre de conseillers permanents hors honoraires émérites au moment du dépôt de la demande de révision. 
...
Pendant une élection de renouvellement partiel, les votes du premier et second tour pourront être initiés d'autres jours que le mercredi ou dimanche ; seules les durées relatives des votes et de l'entre deux tour, de 48h doivent être respectées. Ces votes devront toujours être initiés en journée.
\subarticle{}
A chaque renouvellement (trimestriel comme exceptionnel), le scrutin s’opère en deux tours. Le conseil permanent initie le vote du premier tour un mercredi en journée, sur le canal approprié. Ce vote sera clos le vendredi de la même semaine, 48h après.
Le vote du second tour s'effectuera également pendant 48h : du dimanche en journée au mardi de la semaine suivante.
Les citoyens peuvent choisir autant de candidats qu’il y a de postes à pourvoir. 
A l’issue du premier tour, s’il y a $n$ sièges à pourvoir, les $n + 2$ personnes au maximum, ayant obtenu le plus de voix et qui souhaitent y participer, peuvent prendre part au second.
En cas d'égalités à l'issue du premier tour, on ne gardera pour le deuxième tour que l'ensemble des personnes les mieux classées, jusqu'à atteindre au moins $n+2$ individus, en incluant tous les ex aequo du premier au dernier rang retenu dans le classement dégénéré. En cas d'égalités à l'issue du deuxième tour, on ne gardera également que les personnes les mieux classées, jusqu'à atteindre au moins $n$ individus. On effectuera ensuite un tirage au sort entre les individus les moins bien classés qui ont été gardés pour en conserver le nombre nécessaire pour atteindre le nombre d'élus requis.
Si il y a moins de $n + 2$ candidats au premier tour, on n’effectue qu’un seul tour en appliquant les modalités du second tour en cas d'égalité. De plus, il faut obtenir au minimum 3 voix au dernier tour pour être élu.
\subarticle{Absentéisme}
Un membre du conseil constitutionnel doit le quitter s’il perd la citoyenneté, s’il démissionne, ou s’il n’a participé à aucun vote du conseil constitutionnel lors des trois dernières semaines où de tels votes ont eu lieu. La dernière condition ne s’applique pas aux honoraires émérites. 
...
\article{}
Des propositions de loi dans des domaines non listés dans l'\reftarget{application lois} pourront également être soumises.
Le conseil devra s'assurer qu'elle ne peuvent représenter une menace pour l'Ernestie, son organisation ou fonctionnement, ou pour une partie de ses membres.
L'auteur d'une telle proposition de loi pourra spécifier qu'elle n'a aucune valeur normative, s'il ne souhaite pas contrevenir au point précédent.
...
\subarticle{}
La prise de décision est effectuée par les citoyens à la majorité stricte (proportion strictement supérieure à 50\%), par le vote d’une proposition de loi sur le canal "votes" du serveur Discord de l'Ernestie.
...
\subarticle{}
Après sept jours à compter de l’heure d’émission du vote de la proposition de loi (UTC+1) par le conseil constitutionnel, la décision est prise à la majorité relative, sous réserve de l’expression d’au moins un citoyen.
\subarticle{}
Toute situation de majorité absolue constatée avant les sept jours par le conseil et respectant les conditions de l’\reftarget{Constitutionnalité} conduit à l’adoption immédiate de la proposition de loi.
\article{}
...
\article{}
Les responsables administratifs sont nommés par le conseil constitutionnel à l'exception des maires. Le conseil peut révoquer leur mandat à tout moment. Ces responsables peuvent représenter le conseil et doivent lui rendre compte de chacune de leurs interventions officielles. 
\article{}
...
\article{} 
Les représentants municipaux (maires, adjoints) possèdent également le statut de responsables administratifs. Ils agissent localement au nom, et sous l'autorité du conseil constitutionnel. Leurs rôles et prérogatives sont encadrés par le code général communal. 
...
\articleref{}{revisions constitutionnelles safe}
Les révisions constitutionnelles doivent en aucun cas représenter de menace pour la DENS, et pour l'esprit initial de la constitution.
\article{}
Toute modification ou révision constitutionnelle doit s’accompagner d’un vote à majorité stricte au troisième quartile (à plus de ¾ en proportion de voix en faveur de ladite révision) des citoyens et d’une validation du projet de révision par le conseil constitutionnel selon les dispositions de l’\reftarget{revisions constitutionnelles safe}.
\article{}
...
\begin{itemize}
    \item les textes dont la formulation prête à confusion
